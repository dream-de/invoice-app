...
export default async function WebProLicenseBillingBillingInvoicesPage({ searchParams }: DashboardV2SearchPageProps) {
  ...
  return (
    <PremiumWorkspacePage
      ...
      initialSearchQuery={query || "Abrechnung & Rechnungen"}
      initialTheme={theme}
    />
  )
}
