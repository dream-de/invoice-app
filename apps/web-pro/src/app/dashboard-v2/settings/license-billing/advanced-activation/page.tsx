...
export default async function WebProLicenseBillingAdvancedActivationPage({ searchParams }: DashboardV2SearchPageProps) {
  ...
  return (
    <PremiumWorkspacePage
      ...
      initialSearchQuery={query || "Erweiterte Aktivierung"}
      initialTheme={theme}
    />
  )
}
