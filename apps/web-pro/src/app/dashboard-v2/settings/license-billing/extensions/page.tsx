...
export default async function WebProLicenseBillingExtensionsPage({ searchParams }: DashboardV2SearchPageProps) {
  ...
  return (
    <PremiumWorkspacePage
      ...
      initialSearchQuery={query || "Installierte Erweiterungen"}
      initialTheme={theme}
    />
  )
}
