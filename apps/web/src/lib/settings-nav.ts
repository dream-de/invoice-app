...
export type SettingsStatus = "Aktiv" | "Teilweise aktiv" | "Marketplace vorbereitet" | "Nicht eingerichtet"
...
export const settingsNav = [
  ...
  { key: "time-tracking", title: "Zeiterfassung", description: "Feature-Flag-Zugang fuer Zeiten und Projektbezug", href: "/dashboard-v2/settings/time-tracking", icon: CalendarClock, category: "finance", order: 901, status: "Teilweise aktiv", accent: "#0284c7", accentSoft: "#e0f2fe" },
  { key: "billing", title: "Fakturierung", description: "Feature-Flag-Zugang fuer Fakturierungsprozesse", href: "/dashboard-v2/settings/billing", icon: FileText, category: "finance", order: 902, status: "Teilweise aktiv", accent: "#db2777", accentSoft: "#fce7f3" },
  ...
  { key: "api", title: "API", description: "API-Zugaenge, Keys und Versionierung", href: "/dashboard-v2/settings/api", icon: Plug, category: "platform", order: 310, status: "Marketplace vorbereitet", accent: "#9333ea", accentSoft: "#f3e8ff" },
  { key: "webhooks", title: "Webhooks", description: "Webhook-Endpunkte, Events und Logs", href: "/dashboard-v2/settings/webhooks", icon: Webhook, category: "platform", order: 320, status: "Marketplace vorbereitet", accent: "#7e22ce", accentSoft: "#f3e8ff" },
  { key: "integrations", title: "Integrationen", description: "Externe Dienste und Datenuebergaben", href: "/dashboard-v2/settings/integrations", icon: Plug, category: "platform", order: 330, status: "Marketplace vorbereitet", accent: "#0891b2", accentSoft: "#cffafe" },
