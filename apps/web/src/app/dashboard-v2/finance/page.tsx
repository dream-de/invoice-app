...
export default async function PremiumFinancePage({ searchParams }: DashboardV2SearchPageProps) {
  const { query, theme } = await dashboardV2ParamsFromSearchParams(searchParams)

  return <PremiumWorkspacePage view="finance" initialSearchQuery={query} initialTheme={theme} />
}
