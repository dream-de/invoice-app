...
export default async function PremiumLicenseBillingPage({ searchParams }: DashboardV2SearchPageProps) {
  const { query, theme } = await dashboardV2ParamsFromSearchParams(searchParams)

  return <PremiumWorkspacePage view="license-billing" initialSearchQuery={query} initialTheme={theme} />
}
