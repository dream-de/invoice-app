  ...
  return (
    <div className="rounded-[34px] border border-[#e3e9f1] bg-[#f8f9fb] p-8 shadow-[0_8px_26px_rgba(15,23,42,0.05)]">
      ...
      <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
        ...
        >
          <div className="flex h-[290px] flex-col items-center justify-center rounded-[28px] border-2 border-dashed border-[#d6dde8] bg-[#f3f6fa] transition hover:bg-[#edf2f8]">
            <div className="mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-white text-4xl text-[#94a3b8] shadow">
              +
            </div>
