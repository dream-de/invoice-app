...
function createReportResponse(report: string) {
...
export async function GET() {
  if (isDemoMode() || !process.env.DATABASE_URL) {
    return createReportResponse(staticFinanceReport())
  }
  ...
  try {
    ...
    console.error("Finance report failed. Falling back to premium static report.", error)
    return createReportResponse(staticFinanceReport())
  }
}
