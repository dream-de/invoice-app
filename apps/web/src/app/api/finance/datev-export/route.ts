...
export async function GET() {
  if (isDemoMode() || !process.env.DATABASE_URL) {
    return createCsvResponse(staticDatevRows(), "datev-export.csv")
  }
  ...
  try {
    ...
    console.error("DATEV export failed. Falling back to premium static export.", error)
    return createCsvResponse(staticDatevRows(), "datev-export.csv")
  }
}
