...
async function getTimeEntries(request: Request) {
...
export const GET = withApiAuditLog(getTimeEntries, {
  module: "timeTracking",
  title: "API Zeiteintraege abgerufen",
  description: "Externe API hat Zeiteintraege abgerufen."
})
